...
class Settings(metaclass=FreezableMeta):
    ...
    EQUIV_STRATEGIES = ['DONT', 'CEGAR', 'SECOND_NET', 'REFINE_UNTIL_MAX', 'REFINE_UNTIL_95P','REFINE_UNTIL_LAST','REFINE_UNTIL_LAST_OPTIMISTIC1','REFINE_UNTIL_LAST_OPTIMISTIC2']
